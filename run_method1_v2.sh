...
for dataset in cifar10 cifar10n_worst cifar10n_aggre cifar10n_random1 cifar10n_random2 cifar10n_random3
do
    ...
    do
        ...
        do
            ...
            do
                python3 main_method1_v2.py --output "cifar_ins-dep_injection" --seed ${seed}  --noise_type ${nt} --dataset ${dataset} --flip_rate_fixed ${rate} --noise_injection_type "ins"
