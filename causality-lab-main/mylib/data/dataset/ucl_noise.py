...
class UCL_noise(Data.Dataset):
    ...
    def __init__(self,
        ...
        self.noise_data = np.concatenate((self.data, np.expand_dims(self.targets, axis=1)), axis=1)
        # print(self.noise_data)
    ...
    def __getitem__(self, index):
        ...
        return img, target, clean_target, hat_clean_target, img
