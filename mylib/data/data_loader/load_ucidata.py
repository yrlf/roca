...
data_info_dict = {
    ...
    "splice2balance":{
        "mean": (0),
        "std": (1),
        "root": "./datasets/splice2/splice2balance",
        'random_crop': None
    },
    "splice2imbalance":{
        "mean": (0),
        "std": (1),
        "root": "./datasets/splice2/splice2imbalance",
        'random_crop': None
    },
    "bci": {
        "mean": (0),
        "std": (1),
        "root": "./datasets/bci/bci",
        'random_crop': None
    },
    "yxguassian": {
        "mean": (0),
    ...
    "xyguassian100": {
        "mean": (0),
        "std": (1),
        "root": "./datasets/xyguassian/xyguassian100",
        'random_crop': None
    },
    "xyguassian200": {
        "mean": (0),
        "std": (1),
        "root": "./datasets/xyguassian/xyguassian200",
        'random_crop': None
    },
    "xyguassianimba82": {
        "mean": (0),
        "std": (1),
        "root": "./datasets/xyguassian/xyguassianimba82",
        'random_crop': None
    },
    "yxguassian200": {
        "mean": (0),
        "std": (1),
        "root": "./datasets/yxguassian/yxguassian200",
        'random_crop': None
    },
    "yxguassian5000": {
        "mean": (0),
        "std": (1),
        "root": "./datasets/yxguassian/yxguassian5000",
        'random_crop': None
    },
    "yxguassian1000": {
        "mean": (0),
        "std": (1),
        "root": "./datasets/yxguassian/yxguassian1000",
        'random_crop': None
    },
    "xyguassian500": {
        "mean": (0),
        "std": (1),
        "root": "./datasets/xyguassian/xyguassian500",
        'random_crop': None
    },
    "xyguassian1000": {
        "mean": (0),
        "std": (1),
        "root": "./datasets/xyguassian/xyguassian1000",
        'random_crop': None
    },
    "xyguassian5000": {
        "mean": (0),
        "std": (1),
        "root": "./datasets/xyguassian/xyguassian5000",
        'random_crop': None
    },
    "breastcancer": {
        "mean": (0),
...
def load_ucidata(dataset="CIFAR10", num_workers=0, batch_size=128, add_noise=False, noise_type=None, flip_rate_fixed=None, random_state=1, trainval_split=None, train_frac=1, augment=False):
    ...
    test_dataset = mylib.data.dataset.__dict__["UCL_noise"](
        root=root, train=False, transform=None, transform_eval=None, transform_strong=transform_strong, add_noise=False, target_transform=None)
    ...
    train_dataset, val_dataset = create_train_val(
        train_val_dataset, trainval_split, train_frac)
    train_val_dataset = Subset(train_val_dataset, list(
        range(0, len(train_val_dataset), 1)))
    train_val_loader = DataLoader_noise(
        train_val_dataset, batch_size=batch_size, shuffle=False, num_workers=num_workers)
    train_loader = DataLoader_noise(
        train_dataset, batch_size=batch_size, shuffle=True, num_workers=num_workers, drop_last=True)
    val_loader = DataLoader_noise(
        val_dataset, batch_size=batch_size, shuffle=False, num_workers=num_workers)
    est_loader = DataLoader_noise(
        train_dataset, batch_size=batch_size, shuffle=False, num_workers=num_workers)
    test_loader = DataLoader_noise(
        test_dataset, batch_size=batch_size, shuffle=False, num_workers=num_workers)

    return train_val_loader, train_loader, val_loader, est_loader, test_loader


def load_ucidata2(dataset="CIFAR10", num_workers=0, batch_size=128, add_noise=False, noise_type=None, flip_rate_fixed=None, random_state=1, trainval_split=None, train_frac=1, augment=False):
